...
namespace ASCOM.EzDome.Dome
{
    ...
    //
    // Your driver's DeviceID is ASCOM.EzDome.Dome
    //
    // The COM Guid attribute sets the CLSID for ASCOM.EzDome.Dome
    // The COM ClassInterface/None attribute prevents an empty interface called _EzDome from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("937e4b59-0000-488d-ae57-ea7dc1c754a3")]
    [ProgId("EzDome.Dome")]
    [ServedClassName("EzDome")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Dome : ReferenceCountedObjectBase, IDomeV2, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ASCOM.EzDome"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Dome()
        {
            try
            {
                ...
                tl = new TraceLogger("", "EzDome.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
